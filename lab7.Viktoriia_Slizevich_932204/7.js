function DrawFigure(figure)
{
	...
	case 'circle':
		...
		div.addEventListener('click', function() { this.style.backgroundColor = 'gray';});
		break;
	case 'triangle':
		...
		div.addEventListener('click', function() { this.style.borderBottomColor = 'gray';});
		break;
	}
...
function ButtonClick(figure)
{
	...
	{
		alert("Количество фигур должно быть 1-5");
		return 404;
	}
	var i = 0;
	do {
